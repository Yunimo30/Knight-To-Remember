...
export const EnemyTypes = [
    ...
    { id: 4, name: "Syntax Guardian", hp: 5, icon: "fa-gavel" },         // Boss
    ...
    { id: 9, name: "The Compiler", hp: 8, icon: "fa-brain" },            // Boss
    ...
    { id: 13, name: "Stack Tower", hp: 8, icon: "fa-layer-group" },      // Mini-Boss
